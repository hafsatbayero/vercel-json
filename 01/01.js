...
function init() {
  ...
  object.position.copy(
    new THREE.Vector3(-724.4980591504489, -422.0704306519296, 0)
  );
  ...
  object.position.copy(
    new THREE.Vector3(-20.80412947525292, -422.0704306519296, 671.8211996431205)
  );
  ...
  let streetButton3 = document.createElement("A");
  streetButton3.className = "d3DButton";
  streetButton3.href = "/index.html";

  //

  let arrowA3 = document.createElement("A");
  arrowA3.className = "arrowA";
  arrowA3.text = "⬆︎";

  //

  let textContenerButton3 = document.createElement("A");
  //textContenerButton.text = "Go there";

  streetButton3.appendChild(arrowA3);
  streetButton3.appendChild(textContenerButton3);

  //SceneObjects.push(object);

  object = new CSS3DObject(streetButton3);
  object.position.copy(
    new THREE.Vector3(606.1430335642538, -280.5297961232855, 272.1720201965466)
  );
  object.rotation.copy(new THREE.Euler(0, 90 * THREE.MathUtils.DEG2RAD, 0));
